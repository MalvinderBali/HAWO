...
for t = 1:T
    ...
    if (val > limit)
        ...
        Leader_pos=bestsol;
        Max_iter=T;
        Positions=WOA_integration(Max_iter,t,Positions,Leader_pos);
        P(ind,:);
    ...
    %%
disp('===========================================================');
disp(sprintf('iteration : %f ,objective function value %f',t,bj(t)));
%{
if t>1
    if (bj(t)-bj(t-1))==0
        disp('fail to exploit');
        disp(t);
        disp(CombinedSol)
        break;
